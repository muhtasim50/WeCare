...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="style2.css">
      <style >
          body{
              background: -webkit-linear-gradient(left, #f2dede, #f2dede);
          }
      </style>
  ...
  <body style="background: -webkit-linear-gradient(left, blue, #f8b9b7); background-size: cover;">
  <style >
      body{
          background: -webkit-linear-gradient(left, #f2dede, #f2dede);
      }
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp WeCare</h4></a>
