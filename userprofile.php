...
$que="select * from presimage where pid = $pid";
...
if(isset($_POST['cover_up'])) {
    ...
    if(!empty($imgFile)) {
        ...
        if(!isset($errMSG)) {
            $pid = $_SESSION['pid'];
            $contact = $_SESSION['contact'];
            $que = "INSERT INTO presimage(pid, b_image, contact) VALUES($pid, '".$coverpic."', '".$contact."')";
            // $pid = $_SESSION['pid'];
            // $stmt->bindParam(1, $pid);
            // $stmt->bindParam(2, $coverpic);
...
<head>
    ...
    <p><input type="file" name="coverimg" required="required" style="border: #f8b9b7; background: #f8b9b7; shape-margin: 10px ;margin-left: 30%" /></p>
    <p><input type="submit" name="cover_up" style="margin-left: 35%; background-color: #f8b9b7; color: white " class="btn btn-warning" value="Upload"/></p>
    </form>
    <style>
        div.test {
            width:auto;
    ...
    <?php 
        ...
        <div class="block">
            ...
            <img src="uploads/<?=$row['b_image']?>" width="400" height="500">
        </div>
        </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
        <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> WeCare </a>
        ...
        <style >
            body{
                background: -webkit-linear-gradient(left, blue, #f8b9b7);
            }
            .bg-primary {
...
<div class="container-fluid" style="margin-top:50px;">
    ...
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif;"> ID: &nbsp<?php echo $pid ?>
    </h3>
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif;"> Name: &nbsp<?php echo $username ?>
    </h3>
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif;"> Email: &nbsp<?php echo $email ?>
    </h3>
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif;"> Gender: &nbsp<?php echo $gender ?>
    </h3>
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif;"> Contact: &nbsp<?php echo $contact ?>
    </h3>
