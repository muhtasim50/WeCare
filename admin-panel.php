...
<html lang="en">
  ...
  <a class="navbar-brand" href="index.php"><i class="fa fa-user-plus" aria-hidden="true"></i>WeCare </a>
...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   ...
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 50%; color: #f1f1e3 ; padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif;"> <a href="userprofile.php" style="color: #f1f1e3" onclick="clickDiv('#list-home-list')"> Welcome &nbsp<?php echo $username ?> </a>
   </h3>
    <div class="row">
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home">Prescriptions</a>
        <a class="list-group-item list-group-item-action" href="clock.html" id="list-pres-list" role="tab"  aria-controls="home">Alarm</a>
        ...
        <div class="container-fluid container-fullw bg-white" >
               ...
               <div class="col-sm-4" style="left: 1%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h2 class="StepTitle" style="margin-top: 5%;"> Book My Appointment</h2>
                      <script>
                  ...
                  <div class="col-sm-4" style="left: 1%">
                      <div class="panel panel-white no-radius text-center">
                          <div class="panel-body">
                              <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-terminal fa-stack-1x fa-inverse"></i> </span>
                              <h2 class="StepTitle" style="margin-top: 5%;"> MyProfile</h2>
                              <script>
                                  function clickDiv(id) {
                                      document.querySelector(id).click();
                                  }
                              ...
                              <p class="links cl-effect-1">
                                  <a href="userprofile.php" onclick="clickDiv('#list-home-list')">
                                      Go To Profile
                                  </a>
                              </p>
                          </div>
                ...
                <div class="col-sm-4" style="left: 1%; right: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-paperclip fa-stack-1x fa-inverse"></i> </span>
                      <h2 class="StepTitle" style="margin-top: 4%; margin-right: 5%">My Appointments</h2>
                ...
                <div class="col-sm-4" style="left: 5%;margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <h2 class="StepTitle" style="margin-top: 5%; margin-left: 5%">Prescriptions</h2>
            ...
            <div class="col-sm-4" style="left: 10%;margin-top:5%">
                <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                        <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-list-ul fa-stack-1x fa-inverse"></i> </span>
                        <h2 class="StepTitle" style="margin-top: 5%; margin-left: 5%">My Prescriptions</h2>

                        <p class="cl-effect-1">
                            <a href="imag.php" onclick="clickDiv('#list-pres-list')">
